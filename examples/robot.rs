...
use na::{Isometry3, Vector3, UnitQuaternion, Translation3, Real};
...
fn create_joint_with_link_array(name: &str) -> VecKinematicChain<f32> {
    ...
    joint_with_link1.transform =
        Isometry3::from_parts(Translation3::new(0.0, 0.2, 0.0), UnitQuaternion::identity());
    let mut joint_with_link2 = Link::new("link2", j2);
    joint_with_link2.transform =
        Isometry3::from_parts(Translation3::new(0.0, 0.2, 0.0), UnitQuaternion::identity());
    let mut joint_with_link3 = Link::new("link2", j3);
    joint_with_link3.transform =
        Isometry3::from_parts(Translation3::new(0.0, 0.2, 0.0), UnitQuaternion::identity());
    VecKinematicChain::new(
        name,
...
fn main() {
    ...
    lleg.transform =
        Isometry3::from_parts(Translation3::new(0.2, 0.2, 0.0), UnitQuaternion::identity());
    ...
    while window.render() {
        ...
        rf.set_transform(Isometry3::from_parts(
